...
Original file is located at
    https://colab.research.google.com/drive/1XOm8t1pUVOsta8UmxqiqIqhOUKVIT9Qf
"""
    ...
    def compute_shortest_path(self, start, goal):
        ...
        while len(self.OPEN) > 0 and steps < self.max_steps and (u.i, u.j) != self.goal:
            ...
            for d in [(0, 0), (-1, 0), (1, 0), (0, -1), (0, 1)]:
                n = (u.i+d[0], u.j + d[1])
                if n not in self.obstacles and n not in self.CLOSED and n not in self.other_agents  and n not in self.other_agents:
